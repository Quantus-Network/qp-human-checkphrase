...
const BIP39_URL: &str = "https://raw.githubusercontent.com/bitcoin/bips/master/bip-0039/english.txt";
const WORD_COUNT: usize = 2048;
const SALT: &str = "human-readable-checksum";
const ITERATIONS: u32 = 40000;
const CHECKSUM_LEN: usize = 5;
const KEY_BYTECOUNT: usize = (CHECKSUM_LEN * 11 + 7) / 8;
...
pub fn load_bip39_list() -> io::Result<Vec<String>> {
    ...
    // Fetch from URL
    let resp = reqwest::blocking::get(BIP39_URL)
...
mod tests {
    ...
    fn test_checksum() -> io::Result<()> {
        ...
        println!("Total combos: {}", commas(combos));
        println!(
            "Sample: {:?} ... {:?}",
